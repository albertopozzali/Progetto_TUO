...
## 📌 Cos'è TUO?
**TUO** è un sistema di monitoraggio ambientale statico basato su architettura Arduino. Dopo l'esperienza di **AMO** (App Musica Offline), il team si è spostato sull'hardware per creare una stazione di rilevamento solida e affidabile. 
...
* **Stabilità Hardware:** Architettura ottimizzata per una lettura dei dati senza interferenze.
